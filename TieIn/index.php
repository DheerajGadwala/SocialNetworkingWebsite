...
if($result = $con->query($sql)){}else{echo mysqli_error($con);};
$b=0;
...
$datac3=mysqli_query($con,$sql);
$dataa3=$datac3->fetch_array();
$result3 = $con->query($sql);
while($row3 = $result3->fetch_assoc())
{
	$pair_em = $row3['uid'];
	$sql = "insert into tieins values ('$email','$pair_em',0,0,0);";
	$con->query($sql);
	$con->query("commit");
	}

$sql = "INSERT INTO USERS VALUES('$uid','$uname',password('$pass'),'$fn','$ln','$email','$dob','$gender','','assets/imgs/default_profile.png');";
$con->query($sql);
$con->query("commit");
}
...
<h3 class="text-primary">TieIn helps you connect and share with the people in your life.</h3>
<img src="assets/imgs/globe.png" class="img-responsive"/>                            
</div>
</div>
<div class="pull-right col-sm-5">
<div class="signup-form" style="background-color: rgba(255, 255, 255, .70)">
...
<input type="submit" value="Sign up"  name="submit" class="btn btn-success input-lg" >				
